...
void AddNANDgate::Execute()
{
	...
	GraphicsInfo GInfo; //Gfx info to be used to construct the NAND gate
...
bool AddNANDgate::CheckArea(int x1, int x2, int y1, int y2, bool Components)
{
